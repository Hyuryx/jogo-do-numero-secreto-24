        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              A plataforma definitiva para NFTs espaciais e experiências digitais futuristas.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/drops" className="text-gray-400 hover:text-neon-blue transition-colors">
                  Drops
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/careers" className="text-gray-400 hover:text-neon-blue transition-colors">
                  Carreiras
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Fique por dentro de todas as novidades e lançamentos de NFTs.
            </p>
